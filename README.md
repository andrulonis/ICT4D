...
The app will not work right away. Please go to the project settings, add the environment variables according to the table in the [environment variables](#environment-variables) section **and redeploy**.
